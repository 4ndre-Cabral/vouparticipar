<template>
    <div>
      <q-expansion-item :class="$q.platform.is.desktop ? 'text-h6' : 'text-h8'"
        ...
        caption="Você pode escolher mais de uma opção">
        <q-separator />
        <q-card>
            <q-list class="q-pa-md">
                ...
                <q-item-section side top class="q-mt-md">
                    <q-checkbox :label="opcao.label" :key="opcao._id" :val="opcao._id" v-model="selected" @click.native="salvarResposta(opcao)"/>
                </q-item-section>
                </q-item>
            </q-list>
        </q-card>
